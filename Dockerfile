...
RUN pip install tables mplhep jetnet weaver-core pre-commit ogb torch-scatter torch-sparse torch-cluster torch-spline-conv pyg-nightly jupyter_contrib_nbextensions -f https://data.pyg.org/whl/torch-1.12.0+cu116.html
